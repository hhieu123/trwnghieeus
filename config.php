...
$DATABASE = 'websiteq_fb'; // Tên Database *
$USERNAME = 'websiteq_fb'; // User *
$PASSWORD = 'websiteq_fb'; // Pass User *
$LOCALHOST = 'localhost'; 
$site_domain = 'https://likengon.xyz/'; // Link Website * 
...
function sendCSM($mail_nhan,$ten_nhan,$chu_de,$noi_dung,$bcc){
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'neuhinh18@gmail.com'; //GMAIL BOT
        $mail->Password = '0374161510hieu'; // PASS GMAIL BOT
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;
        $mail->setFrom('neuhinh18@gmail.com', $bcc); //GMAIL BOT
        $mail->addAddress($mail_nhan, $ten_nhan);
        $mail->addReplyTo('neuhinh18@gmail.com', $bcc); //GMAIL BOT
        $mail->isHTML(true);
        $mail->Subject = $chu_de;
        $mail->Body    = $noi_dung;
        $mail->CharSet = 'UTF-8';
