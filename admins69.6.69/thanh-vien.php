...
?>
                    ...
                    <tr class="text-center">
                      ...
                      if ($row['banned'] == '0')
                      {
                        echo '<span class="badge bg-success"><font color="#fff">HOẠT ĐỘNG</span>';
                      }
                      else if ($row['banned'] == '1')
                      {
                        echo '<span class="badge bg-danger"><font color="#fff">BANNED</span>';
                      }
                      ?></td>
...
$(document).ready(function () {
  bsCustomFileInput.init();
                            ...
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2022 By<a href="https://www.facebook.com/TrungHieu2k9/">Trwng Hieeus</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
