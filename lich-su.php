...
?>
                  <tr>
                    ...
                    <td class="text-center"><span class="badge badge-default"><b class="text-center"><?=$row['service_name'];?></b></span></td>
                    ...
                    <td class="text-center"><b style="color: dark;"><?=format_cash($row['money']);?></b></td>
